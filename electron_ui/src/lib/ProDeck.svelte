...
<div class="pro-deck deck-{deck}">
    ...
    <div class="track-info">
        ...
        <button class="load-btn" on:click={onLoadTrack}>
            📁 LOAD
        </button>
    </div>
    ...
    <div class="waveform-container" on:click={handleSeek}>
        ...
        <!-- タイムコード -->
        <div class="timecode">
            <span class="time-current">{formatTime(deckInfo.position)}</span>
            <span class="time-separator">/</span>
            <span class="time-total">{formatTime(deckInfo.duration)}</span>
        </div>
    </div>
    ...
    <div class="transport">
        ...
        <button class="transport-btn stop" on:click={onStop}>⏹</button>
        <button 
        ...
        <button class="transport-btn cue" on:click={() => onAddCuePoint(`Cue ${Date.now()}`, deckColor)}>
            📍
        </button>
    </div>
    ...
    <div class="volume-fader">
        ...
        <div class="volume-meter">
            <div class="volume-fill" style="height: {deckInfo.volume * 100}%; background: {deckColor}"></div>
        </div>
    </div>
</div>
